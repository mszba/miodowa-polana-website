...
const InfoSection = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (scrollY >= attractionsContainer.offsetTop - 400) {
                ...
                <TextWrapper>
                  ...
                  <motion.div
                    ...
                    <Subtitle darkText={false}>
                      W naszej okolicy znajduje się wiele ciekakawych atrakcji
                      dla chcących odpocząć, dzieci jak i również aktywnych
                      fizycznie. Każdy znajdzie coś dla siebie:
                    </Subtitle>
                    <AttractionsList>
                      <AttractionsElement>
